...
Iga Swiatek faced 6 break points total.
Iga Swiatek faced 26 game points total.
Iga Swiatek faced 5 break points while serving and won 3 of them.
Iga Swiatek faced 1 break points while returning and won 0 of them.
Iga Swiatek faced 12 game points while serving and won 9 of them.
Iga Swiatek faced 14 game points while returning and won 3 of them.
Iga Swiatek played 11 deuce points while serving and won 6 of them.
Iga Swiatek played 11 deuce points while returning and won 1 of them.

JESSICA PEGULA KEY POINTS AUTHORITATIVE TOTALS:
Jessica Pegula faced 6 break points total.
Jessica Pegula faced 26 game points total.
Jessica Pegula faced 1 break points while serving and won 1 of them.
Jessica Pegula faced 5 break points while returning and won 2 of them.
Jessica Pegula faced 14 game points while serving and won 11 of them.
Jessica Pegula faced 12 game points while returning and won 3 of them.
Jessica Pegula played 11 deuce points while serving and won 10 of them.
Jessica Pegula played 11 deuce points while returning and won 5 of them.
...
Iga Swiatek played 5 break points faced when serving.
Iga Swiatek won 3 break points faced when serving, or 60% of break points faced when serving for Iga Swiatek.
Iga Swiatek made 2 first serves in on break points faced when serving, or 40% of break points faced when serving for Iga Swiatek.
Iga Swiatek hit 0 aces on break points faced when serving, or 0% of break points faced when serving for Iga Swiatek.
Iga Swiatek hit 1 serve winners on break points faced when serving, or 20% of break points faced when serving for Iga Swiatek.
Iga Swiatek hit 0 rally winners on break points faced when serving, or 0% of break points faced when serving for Iga Swiatek.
Iga Swiatek forced 0 errors on break points faced when serving, or 0% of break points faced when serving for Iga Swiatek.
Iga Swiatek made 1 unforced errors on break points faced when serving, or 20% of break points faced when serving for Iga Swiatek.
Iga Swiatek made 0 double faults on break points faced when serving, or 0% of break points faced when serving for Iga Swiatek.
Jessica Pegula played 1 break points faced when serving.
Jessica Pegula won 1 break points faced when serving, or 100% of break points faced when serving for Jessica Pegula.
Jessica Pegula made 1 first serves in on break points faced when serving, or 100% of break points faced when serving for Jessica Pegula.
Jessica Pegula hit 0 aces on break points faced when serving, or 0% of break points faced when serving for Jessica Pegula.
Jessica Pegula hit 0 serve winners on break points faced when serving, or 0% of break points faced when serving for Jessica Pegula.
Jessica Pegula hit 1 rally winners on break points faced when serving, or 100% of break points faced when serving for Jessica Pegula.
Jessica Pegula forced 0 errors on break points faced when serving, or 0% of break points faced when serving for Jessica Pegula.
Jessica Pegula made 0 unforced errors on break points faced when serving, or 0% of break points faced when serving for Jessica Pegula.
Jessica Pegula made 0 double faults on break points faced when serving, or 0% of break points faced when serving for Jessica Pegula.
Iga Swiatek played 12 game points when serving.
Iga Swiatek won 9 game points when serving, or 75% of game points when serving for Iga Swiatek.
Iga Swiatek made 7 first serves in on game points when serving, or 58% of game points when serving for Iga Swiatek.
Iga Swiatek hit 4 aces on game points when serving, or 33% of game points when serving for Iga Swiatek.
Iga Swiatek hit 2 serve winners on game points when serving, or 17% of game points when serving for Iga Swiatek.
Iga Swiatek hit 1 rally winners on game points when serving, or 8% of game points when serving for Iga Swiatek.
Iga Swiatek forced 1 errors on game points when serving, or 8% of game points when serving for Iga Swiatek.
Iga Swiatek made 0 unforced errors on game points when serving, or 0% of game points when serving for Iga Swiatek.
Iga Swiatek made 0 double faults on game points when serving, or 0% of game points when serving for Iga Swiatek.
Jessica Pegula played 14 game points when serving.
Jessica Pegula won 11 game points when serving, or 79% of game points when serving for Jessica Pegula.
Jessica Pegula made 12 first serves in on game points when serving, or 86% of game points when serving for Jessica Pegula.
Jessica Pegula hit 0 aces on game points when serving, or 0% of game points when serving for Jessica Pegula.
Jessica Pegula hit 2 serve winners on game points when serving, or 14% of game points when serving for Jessica Pegula.
Jessica Pegula hit 2 rally winners on game points when serving, or 14% of game points when serving for Jessica Pegula.
Jessica Pegula forced 1 errors on game points when serving, or 7% of game points when serving for Jessica Pegula.
Jessica Pegula made 0 unforced errors on game points when serving, or 0% of game points when serving for Jessica Pegula.
Jessica Pegula made 1 double faults on game points when serving, or 7% of game points when serving for Jessica Pegula.
...
Iga Swiatek hit 120 total shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.

SHOT TYPE BREAKDOWN (these sum to total above, do not add again):
Iga Swiatek hit 69 forehand shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.
Iga Swiatek hit 48 backhand shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.
Iga Swiatek hit 3 backhand slice shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.

AUTHORITATIVE TOTALS BY DIRECTION (these sum to total above, do not add again):
Iga Swiatek hit 57 total crosscourt shots.
Iga Swiatek hit 19 total inside-out shots.
Iga Swiatek hit 10 total down the line shots.
Iga Swiatek hit 34 total down the middle shots.
Iga Swiatek hit 0 total inside-in shots.
...
Jessica Pegula hit 110 total shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.

SHOT TYPE BREAKDOWN (these sum to total above, do not add again):
Jessica Pegula hit 64 forehand shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.
Jessica Pegula hit 30 backhand shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.
Jessica Pegula hit 16 backhand slice shots in all directions including crosscourt, down the middle, down the line, inside-out, and inside-in.

AUTHORITATIVE TOTALS BY DIRECTION (these sum to total above, do not add again):
Jessica Pegula hit 33 total crosscourt shots.
Jessica Pegula hit 10 total inside-out shots.
Jessica Pegula hit 17 total down the line shots.
Jessica Pegula hit 50 total down the middle shots.
Jessica Pegula hit 0 total inside-in shots.
...
EXPLICIT TOTALS FOR SHOT DIRECTION + OUTCOME COMBINATIONS:
--------------------------------------------------
Iga Swiatek hit 12 crosscourt winners total, including 8 forehand crosscourt winners, 3 backhand crosscourt winners, and 1 slice crosscourt winners
Iga Swiatek made 2 crosscourt induced forced errors total, including 2 forehand crosscourt induced forced errors, 0 backhand crosscourt induced forced errors, and 0 slice crosscourt induced forced errors
Iga Swiatek made 13 crosscourt unforced errors total, including 5 forehand crosscourt unforced errors, 8 backhand crosscourt unforced errors, and 0 slice crosscourt unforced errors
Iga Swiatek won 28 crosscourt points won total, including 18 forehand crosscourt points won, 8 backhand crosscourt points won, and 2 slice crosscourt points won
Iga Swiatek lost 29 crosscourt points lost total, including 16 forehand crosscourt points lost, 13 backhand crosscourt points lost, and 0 slice crosscourt points lost
Iga Swiatek hit 0 down middle winners total, including 0 forehand down middle winners, 0 backhand down middle winners, and 0 slice down middle winners
Iga Swiatek made 1 down middle induced forced errors total, including 1 forehand down middle induced forced errors, 0 backhand down middle induced forced errors, and 0 slice down middle induced forced errors
Iga Swiatek made 7 down middle unforced errors total, including 3 forehand down middle unforced errors, 4 backhand down middle unforced errors, and 0 slice down middle unforced errors
Iga Swiatek won 17 down middle points won total, including 8 forehand down middle points won, 9 backhand down middle points won, and 0 slice down middle points won
Iga Swiatek lost 17 down middle points lost total, including 6 forehand down middle points lost, 11 backhand down middle points lost, and 0 slice down middle points lost
Iga Swiatek hit 3 down the line winners total, including 3 forehand down the line winners, 0 backhand down the line winners, and 0 slice down the line winners
Iga Swiatek made 1 down the line induced forced errors total, including 1 forehand down the line induced forced errors, 0 backhand down the line induced forced errors, and 0 slice down the line induced forced errors
Iga Swiatek made 0 down the line unforced errors total, including 0 forehand down the line unforced errors, 0 backhand down the line unforced errors, and 0 slice down the line unforced errors
Iga Swiatek won 6 down the line points won total, including 4 forehand down the line points won, 2 backhand down the line points won, and 0 slice down the line points won
Iga Swiatek lost 4 down the line points lost total, including 2 forehand down the line points lost, 1 backhand down the line points lost, and 1 slice down the line points lost
Iga Swiatek hit 2 inside-out winners total, including 1 forehand inside-out winners, 1 backhand inside-out winners, and 0 slice inside-out winners
Iga Swiatek made 0 inside-out induced forced errors total, including 0 forehand inside-out induced forced errors, 0 backhand inside-out induced forced errors, and 0 slice inside-out induced forced errors
Iga Swiatek made 5 inside-out unforced errors total, including 3 forehand inside-out unforced errors, 2 backhand inside-out unforced errors, and 0 slice inside-out unforced errors
Iga Swiatek won 6 inside-out points won total, including 4 forehand inside-out points won, 2 backhand inside-out points won, and 0 slice inside-out points won
Iga Swiatek lost 13 inside-out points lost total, including 11 forehand inside-out points lost, 2 backhand inside-out points lost, and 0 slice inside-out points lost
Iga Swiatek hit 0 inside-in winners total, including 0 forehand inside-in winners, 0 backhand inside-in winners, and 0 slice inside-in winners
Iga Swiatek made 0 inside-in induced forced errors total, including 0 forehand inside-in induced forced errors, 0 backhand inside-in induced forced errors, and 0 slice inside-in induced forced errors
Iga Swiatek made 0 inside-in unforced errors total, including 0 forehand inside-in unforced errors, 0 backhand inside-in unforced errors, and 0 slice inside-in unforced errors
Iga Swiatek won 0 inside-in points won total, including 0 forehand inside-in points won, 0 backhand inside-in points won, and 0 slice inside-in points won
Iga Swiatek lost 0 inside-in points lost total, including 0 forehand inside-in points lost, 0 backhand inside-in points lost, and 0 slice inside-in points lost
Jessica Pegula hit 2 crosscourt winners total, including 2 forehand crosscourt winners, 0 backhand crosscourt winners, and 0 slice crosscourt winners
Jessica Pegula made 3 crosscourt induced forced errors total, including 3 forehand crosscourt induced forced errors, 0 backhand crosscourt induced forced errors, and 0 slice crosscourt induced forced errors
Jessica Pegula made 1 crosscourt unforced errors total, including 1 forehand crosscourt unforced errors, 0 backhand crosscourt unforced errors, and 0 slice crosscourt unforced errors
Jessica Pegula won 22 crosscourt points won total, including 14 forehand crosscourt points won, 5 backhand crosscourt points won, and 3 slice crosscourt points won
Jessica Pegula lost 11 crosscourt points lost total, including 9 forehand crosscourt points lost, 1 backhand crosscourt points lost, and 1 slice crosscourt points lost
Jessica Pegula hit 2 down middle winners total, including 2 forehand down middle winners, 0 backhand down middle winners, and 0 slice down middle winners
Jessica Pegula made 1 down middle induced forced errors total, including 0 forehand down middle induced forced errors, 1 backhand down middle induced forced errors, and 0 slice down middle induced forced errors
Jessica Pegula made 4 down middle unforced errors total, including 3 forehand down middle unforced errors, 1 backhand down middle unforced errors, and 0 slice down middle unforced errors
Jessica Pegula won 30 down middle points won total, including 18 forehand down middle points won, 7 backhand down middle points won, and 5 slice down middle points won
Jessica Pegula lost 20 down middle points lost total, including 9 forehand down middle points lost, 7 backhand down middle points lost, and 4 slice down middle points lost
Jessica Pegula hit 1 down the line winners total, including 1 forehand down the line winners, 0 backhand down the line winners, and 0 slice down the line winners
Jessica Pegula made 1 down the line induced forced errors total, including 0 forehand down the line induced forced errors, 1 backhand down the line induced forced errors, and 0 slice down the line induced forced errors
Jessica Pegula made 5 down the line unforced errors total, including 2 forehand down the line unforced errors, 3 backhand down the line unforced errors, and 0 slice down the line unforced errors
Jessica Pegula won 6 down the line points won total, including 3 forehand down the line points won, 3 backhand down the line points won, and 0 slice down the line points won
Jessica Pegula lost 11 down the line points lost total, including 6 forehand down the line points lost, 3 backhand down the line points lost, and 2 slice down the line points lost
Jessica Pegula hit 3 inside-out winners total, including 2 forehand inside-out winners, 1 backhand inside-out winners, and 0 slice inside-out winners
Jessica Pegula made 2 inside-out induced forced errors total, including 0 forehand inside-out induced forced errors, 2 backhand inside-out induced forced errors, and 0 slice inside-out induced forced errors
Jessica Pegula made 2 inside-out unforced errors total, including 1 forehand inside-out unforced errors, 1 backhand inside-out unforced errors, and 0 slice inside-out unforced errors
Jessica Pegula won 5 inside-out points won total, including 2 forehand inside-out points won, 3 backhand inside-out points won, and 0 slice inside-out points won
Jessica Pegula lost 5 inside-out points lost total, including 3 forehand inside-out points lost, 1 backhand inside-out points lost, and 1 slice inside-out points lost
Jessica Pegula hit 0 inside-in winners total, including 0 forehand inside-in winners, 0 backhand inside-in winners, and 0 slice inside-in winners
Jessica Pegula made 0 inside-in induced forced errors total, including 0 forehand inside-in induced forced errors, 0 backhand inside-in induced forced errors, and 0 slice inside-in induced forced errors
Jessica Pegula made 0 inside-in unforced errors total, including 0 forehand inside-in unforced errors, 0 backhand inside-in unforced errors, and 0 slice inside-in unforced errors
Jessica Pegula won 0 inside-in points won total, including 0 forehand inside-in points won, 0 backhand inside-in points won, and 0 slice inside-in points won
Jessica Pegula lost 0 inside-in points lost total, including 0 forehand inside-in points lost, 0 backhand inside-in points lost, and 0 slice inside-in points lost
